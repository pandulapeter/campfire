...
import com.pandulapeter.campfire.domain.implementation.useCases.SaveTranspositionsUseCaseImpl
import com.pandulapeter.campfire.domain.implementation.useCases.SaveUserPreferencesUseCaseImpl
import com.pandulapeter.campfire.domain.implementation.useCases.TransposeRawSongDetailsUseCaseImpl
...
val domainModule = module {
    ...
    factory<SaveTranspositionsUseCase> { SaveTranspositionsUseCaseImpl(get()) }
    factory<TransposeRawSongDetailsUseCase> { TransposeRawSongDetailsUseCaseImpl() }
}
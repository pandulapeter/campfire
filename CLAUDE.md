...
- `:app:android` is a plain Android module, `:app:desktop` a plain JVM one and `:app:ios` Kotlin/Native-only; every other module (`:presentation` included) is a multiplatform library.

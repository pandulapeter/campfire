...
app:android / app:desktop / app:ios        entry points, Koin startup, platform chrome (app:ios also holds the Xcode project)
  presentation:android / :desktop / :ios     thin platform Compose shells (system bars, URL opening, desktop key handling)
    presentation:shared                      CampfireViewModel, Navigation 3 back stack, Material 3 theme + every screen, string resources

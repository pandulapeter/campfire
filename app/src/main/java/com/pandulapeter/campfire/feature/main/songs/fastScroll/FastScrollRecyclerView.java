...
public class FastScrollRecyclerView extends RecyclerView implements RecyclerView.OnItemTouchListener {
    ...
    private FastScrollRecyclerView.ScrollPositionState mScrollPosState = new FastScrollRecyclerView.ScrollPositionState();
    ...
    private FastScrollRecyclerView.ScrollOffsetInvalidator mScrollOffsetInvalidator;
    ...
    public String scrollToPositionAtProgress(float touchFraction) {
        ...
        if (!(getAdapter() instanceof FastScrollRecyclerView.SectionedAdapter)) {
            return "";
        }

        int posInt = (int) ((touchFraction == 1) ? itemPos - 1 : itemPos);

        FastScrollRecyclerView.SectionedAdapter sectionedAdapter = (FastScrollRecyclerView.SectionedAdapter) getAdapter();
    ...
    private float findItemPosition(float touchFraction) {
        ...
        if (getAdapter() instanceof FastScrollRecyclerView.MeasurableAdapter) {
            FastScrollRecyclerView.MeasurableAdapter measurer = (FastScrollRecyclerView.MeasurableAdapter) getAdapter();
     ...
     */
    private void getCurScrollState(FastScrollRecyclerView.ScrollPositionState stateOut) {
        stateOut.rowIndex = -1;
     ...
     * should only be called when the attached adapter implements {@link FastScrollRecyclerView.MeasurableAdapter}.
     *
     ...
     * attached adapter implements {@link FastScrollRecyclerView.MeasurableAdapter}.
     *
